<template>
    ...
    <form class="signupmodal__form" autocomplete="off" @submit.prevent="signupNow">
        <div class="signupmodal__field">
            ...
            <input type="email" class="signupmodal__input" v-model="signup.email" placeholder="Enter your email"
                required autocomplete="username" />
        </div>
        <div class="signupmodal__field">
            <label for="signup-fullname" class="signupmodal__label">Full Name</label>
            <input type="text" class="signupmodal__input" v-model="signup.name" placeholder="Enter your full name"
                required autocomplete="name" />
        </div>
        <div class="signupmodal__field">
            <label for="signup-password" class="signupmodal__label">Password</label>
            <input type="password" class="signupmodal__input" v-model="signup.password" placeholder="Create a password"
                required autocomplete="new-password" />
        </div>
        <div class="signupmodal__field">
            <label for="signup-confirm" class="signupmodal__label">Confirm Password</label>
            <input type="password" class="signupmodal__input" v-model="confirm_password"
