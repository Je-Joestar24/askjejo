<template>
    <div class="form-actions" v-if="state.isEditing">
        ...
        <button type="submit" class="btn btn-primary" :disabled="!hasProfileChanges" aria-label="Save profile changes">
...
const hasProfileChanges = computed(() => store.getters.hasProfileChanges)
const hasPasswordChanges = computed(() => store.getters.hasPasswordChanges)
